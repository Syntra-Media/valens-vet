...
const Page = () => {
    ...
    return (
        <div className="flex w-full justify-center">
            <div className="flex flex-col lg:flex-row w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-24 gap-8 lg:gap-16">
                <form className="flex w-full lg:w-1/2 flex-col gap-4" onSubmit={handleSubmit}>
                    {
                        mode === "create" ? (
                ...
                <div className="flex w-full lg:w-1/2 bg-neutral-800/10 rounded-lg">
                    <div className="m-4 sm:m-8 w-full flex flex-col">
                        <h2 className="text-2xl font-bold mb-2">
                            Postlar
                        </h2>
                        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
                            {posts.map((post) => (
                                <div key={post.id} className="flex flex-col gap-2 rounded-lg p-2 border border-neutral-900/50">
